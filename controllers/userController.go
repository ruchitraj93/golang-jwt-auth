...
import (
	...
	"github.com/ruchit/golang-jwt-project/database"
	helper "github.com/ruchit/golang-jwt-project/helpers"
	"github.com/ruchit/golang-jwt-project/models"
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		password := HashPassord(*user.Password)
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		passowordIsValid, msg := VerifyPassword(*user.Password, *foundUser.Password)
		defer cancel()
		if !passowordIsValid {
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
